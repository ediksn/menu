...
export default class Acts extends React.Component {
  render() {
    if(!this.props.act) return null
    return (
      <Modal visible={this.props.visible} transparent={true}>
        <View style={estilos.back}>
          <View style={estilos.cont}>
            <View style={estilos.barra}>
                <TouchableHighlight onPress={() => this.props.cerrarAct(false)}>
                    <Icon
                        name="close"
              ...
              <View
                ...
                <Icon name="clipboard" style={{color: 'white'}} />
                <Text
            ...
            <View style={estilos.cuerpo}>
              <View style={estilos.item}>
                <Image
                    source={{ uri : this.props.act.image[0] ? url + this.props.act.image[0].url : url}}
                    style={{
                        width:ancho*0.7,
                        height:alto*0.3
                    }}
                ...
                <Text
                    onPress={() => {
                        this.props.navigation.navigate('Restaurant', {
                            profile: this.props.act.profileId,
                        })
                        this.props.cerrarAct(false)
                    }} 
                    numberOfLines={10}
                    style={estilos.boton}>
                    Ir al Restaurante
